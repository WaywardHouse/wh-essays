...
date: 2026-02-21
description: >
  A treatise on the global oil market Alberta actually sells into —
  shaped by wars, sanctions, a shadow shipping economy, China's
  extraordinary renewable buildout, and the profoundly uneven demand
  profiles of the world's major population centres.
categories:
  - "Economic Geography"
image: assets/images/political-economy.webp
toc: true
---
...
This article examines the global energy market as Alberta's oil sands producers actually encounter it: a market shaped by active wars, cascading sanctions regimes, a shadow shipping economy, the extraordinary solar and wind buildout concentrated in China, and the profoundly uneven demand profiles of the major population centres of the world.
...
Scroll through the sequence below. The core story is not that sanctions removed Russian oil from the market. It is that they rerouted it, discounted it, and changed where Alberta competes.

::: {.story-section}
::: {.story-sticky}
<div class="story-graphic">
  <div id="contested-supply-story" data-viz="echarts" style="height:420px; min-height:320px" data-options='{"backgroundColor":"transparent","title":{"text":"Russian Crude: The Great Reshuffling","subtext":"Sanctions changed direction and price more than total availability","left":"center","textStyle":{"color":"var(--text)","fontSize":14,"fontWeight":"normal"},"subtextStyle":{"color":"var(--text-muted)","fontSize":11}},"tooltip":{"trigger":"axis"},"legend":{"bottom":0,"textStyle":{"color":"var(--text-muted)"}},"grid":{"left":"10%","right":"8%","top":"20%","bottom":"18%"},"xAxis":{"type":"category","data":["2021","2022","2023","2024"],"axisLabel":{"color":"var(--text-muted)"},"axisLine":{"lineStyle":{"color":"var(--border)"}}},"yAxis":{"type":"value","name":"million bbl/day","nameTextStyle":{"color":"var(--text-muted)"},"axisLabel":{"color":"var(--text-muted)"},"splitLine":{"lineStyle":{"color":"var(--border)"}}},"series":[{"name":"EU imports from Russia","type":"line","data":[3.5,2.2,0.8,0.4],"smooth":true,"lineStyle":{"width":4,"color":"#c44e4e"},"itemStyle":{"color":"#c44e4e"}},{"name":"China imports from Russia","type":"line","data":[1.6,1.9,2.5,2.8],"smooth":true,"lineStyle":{"width":2.5,"color":"#c5a44e"},"itemStyle":{"color":"#c5a44e"}},{"name":"India imports from Russia","type":"line","data":[0.04,0.7,1.3,1.6],"smooth":true,"lineStyle":{"width":2.5,"color":"#4e8ac4"},"itemStyle":{"color":"#4e8ac4"}}]}'></div>
</div>
:::
::: {.story-steps}
::: {.story-step data-step="0" data-update='{"contested-supply-story":{"title":{"subtext":"Sanctions changed direction and price more than total availability"},"series":[{"lineStyle":{"width":4,"color":"#c44e4e"},"itemStyle":{"color":"#c44e4e"}},{"lineStyle":{"width":2.5,"color":"#c5a44e"},"itemStyle":{"color":"#c5a44e"}},{"lineStyle":{"width":2.5,"color":"#4e8ac4"},"itemStyle":{"color":"#4e8ac4"}}]}}'}
### The first move: Europe exits

The Western sanctions architecture was supposed to constrain Russia by squeezing its oil revenues while keeping global supply stable. What happened first was visible and dramatic: Europe's imports collapsed.
:::

::: {.story-step data-step="1" data-update='{"contested-supply-story":{"title":{"subtext":"The barrels did not disappear. They moved east."},"series":[{"lineStyle":{"width":2.5,"color":"#8b95a1"},"itemStyle":{"color":"#8b95a1"}},{"lineStyle":{"width":4,"color":"#c5a44e"},"itemStyle":{"color":"#c5a44e"}},{"lineStyle":{"width":4,"color":"#4e8ac4"},"itemStyle":{"color":"#4e8ac4"}}]}}'}
### The second move: Asia absorbs the flow

China and India become the key buyers. The result is not a simple supply loss. It is a reconfigured market in which discounted Russian barrels keep circulating and keep capping upside elsewhere.
:::

::: {.story-step data-step="2" data-update='{"contested-supply-story":{"title":{"subtext":"A shadow fleet and heavy discounts turn sanctions into a price ceiling."},"series":[{"lineStyle":{"width":2.5,"color":"#8b95a1"},"itemStyle":{"color":"#8b95a1"}},{"lineStyle":{"width":3,"color":"#c5a44e"},"itemStyle":{"color":"#c5a44e"},"markPoint":{"data":[{"coord":["2024",2.8],"value":"$171M/day","label":{"color":"#c5a44e"}}]}},{"lineStyle":{"width":3,"color":"#4e8ac4"},"itemStyle":{"color":"#4e8ac4"},"markPoint":{"data":[{"coord":["2024",1.6],"value":"$144M/day","label":{"color":"#4e8ac4"}}]}}]}}'}
### The market response: discount, don't remove

Once buyers are willing to accept opaque shipping, the sanctioning system stops behaving like a true supply cut. It behaves more like a discount mechanism, which is bad for Russia's margins but also bad for Alberta's price upside.
:::

::: {.story-step data-step="3" data-update='{"contested-supply-story":{"title":{"subtext":"For Alberta, the issue is not scarcity. It is competing inside a rerouted market."},"series":[{"lineStyle":{"width":3,"color":"#c44e4e"},"itemStyle":{"color":"#c44e4e"}},{"lineStyle":{"width":3,"color":"#c5a44e"},"itemStyle":{"color":"#c5a44e"}},{"lineStyle":{"width":3,"color":"#4e8ac4"},"itemStyle":{"color":"#4e8ac4"}}]}}'}
### The Alberta implication

Alberta benefits from some of the reshuffling, especially where displaced trade opens refining capacity in Asia. But the same system also keeps a lid on the sustained high prices greenfield oil sands projects want.
:::
:::
:::
...
This next section is also easier to read as motion rather than a static fact dump. The renewable story is not just "China built a lot." It is how quickly the growth curve steepened, and what that does to future oil demand.

::: {.story-section}
::: {.story-sticky}
<div class="story-graphic">
  <div id="contested-renewables-story" data-viz="echarts" style="height:430px; min-height:320px" data-options='{"backgroundColor":"transparent","title":{"text":"China Renewable Energy Capacity","subtext":"Scroll through the acceleration from target-setting to system-level scale","left":"center","textStyle":{"color":"var(--text)","fontSize":14,"fontWeight":"normal"},"subtextStyle":{"color":"var(--text-muted)","fontSize":11}},"tooltip":{"trigger":"axis","axisPointer":{"type":"shadow"}},"legend":{"bottom":0,"textStyle":{"color":"var(--text-muted)"}},"grid":{"left":"10%","right":"8%","top":"20%","bottom":"18%"},"xAxis":{"type":"category","data":["2020","2022","2023","2024","May 2025","Aug 2025"],"axisLabel":{"color":"var(--text-muted)"},"axisLine":{"lineStyle":{"color":"var(--border)"}}},"yAxis":{"type":"value","name":"GW installed","nameTextStyle":{"color":"var(--text-muted)"},"axisLabel":{"color":"var(--text-muted)"},"splitLine":{"lineStyle":{"color":"var(--border)"}}},"series":[{"name":"Solar","type":"bar","stack":"total","data":[282,392,610,887,1080,1200],"itemStyle":{"color":"#e8cc6a"}},{"name":"Wind","type":"bar","stack":"total","data":[299,365,441,521,567,580],"itemStyle":{"color":"#4e8ac4"}}]}'></div>
</div>
:::
::: {.story-steps}
::: {.story-step data-step="0" data-update='{"contested-renewables-story":{"title":{"subtext":"Scroll through the acceleration from target-setting to system-level scale"}}'}
### The setup

In 2020, China set an enormous target. At the time it still looked like a long-range industrial ambition, not an imminent restructuring of the global energy system.
:::

::: {.story-step data-step="1" data-update='{"contested-renewables-story":{"title":{"subtext":"By 2024, China was adding renewable capacity at a pace no other country could match."},"series":[{"itemStyle":{"color":"#e8cc6a"},"markPoint":{"data":[{"coord":["2024",887],"value":"277 GW added","label":{"color":"#e8cc6a"}}]}},{"itemStyle":{"color":"#4e8ac4"}}]}}'}
### The acceleration

Then the curve steepened. Solar additions in 2024 alone exceeded the total installed solar capacity of most countries. This is where the scale becomes hard to intuit and starts to matter structurally.
:::

::: {.story-step data-step="2" data-update='{"contested-renewables-story":{"title":{"subtext":"By 2025, cumulative solar crossed one terawatt and renewables overtook fossil capacity."},"series":[{"itemStyle":{"color":"#c5a44e"}},{"itemStyle":{"color":"#4e8ac4"},"markLine":{"data":[{"xAxis":"Aug 2025"}],"lineStyle":{"color":"#c44e4e","type":"dashed"},"label":{"formatter":"Renewables > fossil","color":"#c44e4e"}}}]}}'}
### The threshold

Crossing one terawatt is not just a symbolic milestone. It marks the point where renewable capacity stops looking supplementary and starts looking like the backbone of future marginal demand.
:::

::: {.story-step data-step="3" data-update='{"contested-renewables-story":{"title":{"subtext":"For oil markets, the key question is not total displacement. It is growth lost at the margin."},"series":[{"itemStyle":{"color":"#e8cc6a"}},{"itemStyle":{"color":"#4e8ac4"}}]}}'}
### Why Alberta should care

Solar and wind are not replacing every barrel directly. What they are doing is eating the future growth that once justified high expectations for oil demand, especially in the biggest consuming economies.
:::
:::
:::
...
The demand story is where the article stops being about headline geopolitics and becomes about long-run market shape. Read this section as a set of very different energy futures coexisting at once.

::: {.story-section}
::: {.story-sticky}
<div class="story-graphic">
  <div id="contested-demand-story" data-viz="echarts" style="height:420px; min-height:320px" data-options='{"backgroundColor":"transparent","title":{"text":"Per Capita Oil Consumption","subtext":"The demand future depends on who still has room to grow","left":"center","textStyle":{"color":"var(--text)","fontSize":14,"fontWeight":"normal"},"subtextStyle":{"color":"var(--text-muted)","fontSize":11}},"tooltip":{"trigger":"axis","axisPointer":{"type":"shadow"}},"grid":{"left":"24%","right":"12%","top":"20%","bottom":"10%"},"xAxis":{"type":"value","name":"barrels per person per year","nameTextStyle":{"color":"var(--text-muted)"},"axisLabel":{"color":"var(--text-muted)"},"splitLine":{"lineStyle":{"color":"var(--border)"}}},"yAxis":{"type":"category","data":["Sub-Saharan Africa","India","Southeast Asia","China","EU","Middle East","Japan/Korea","United States"],"axisLabel":{"color":"var(--text)"}},"series":[{"type":"bar","barWidth":"60%","data":[{"value":0.9,"itemStyle":{"color":"#6b7280"}},{"value":1.4,"itemStyle":{"color":"#c48a4e"}},{"value":3.5,"itemStyle":{"color":"#c5a44e"}},{"value":4.2,"itemStyle":{"color":"#4e8ac4"}},{"value":8,"itemStyle":{"color":"#8b95a1"}},{"value":18,"itemStyle":{"color":"#c44e4e"}},{"value":19,"itemStyle":{"color":"#c44e4e"}},{"value":22,"itemStyle":{"color":"#dc2626"}}],"label":{"show":true,"position":"right","color":"var(--text-muted)"}}]}'></div>
</div>
:::
::: {.story-steps}
::: {.story-step data-step="0" data-update='{"contested-demand-story":{"title":{"subtext":"The demand future depends on who still has room to grow"}}'}
### Start with the gap

The richest consumers are already near saturation. That matters because future oil demand cannot come from the same places in the same way it did in the twentieth century.
:::

::: {.story-step data-step="1" data-update='{"contested-demand-story":{"title":{"subtext":"China is large, but its growth phase is already compressing."},"series":[{"data":[{"value":0.9,"itemStyle":{"color":"#6b7280"}},{"value":1.4,"itemStyle":{"color":"#c48a4e"}},{"value":3.5,"itemStyle":{"color":"#c5a44e"}},{"value":4.2,"itemStyle":{"color":"#4e8ac4"}},{"value":8,"itemStyle":{"color":"#8b95a1"}},{"value":18,"itemStyle":{"color":"#c44e4e"}},{"value":19,"itemStyle":{"color":"#c44e4e"}},{"value":22,"itemStyle":{"color":"#8b95a1"}}]}]}}'}
### China is not the old growth story anymore

China still matters enormously in absolute volume, but it no longer looks like an endlessly expanding demand engine. That changes the ceiling for producers who built their expectations around the China boom years.
:::

::: {.story-step data-step="2" data-update='{"contested-demand-story":{"title":{"subtext":"India has the strongest growth runway among major demand centres."},"series":[{"data":[{"value":0.9,"itemStyle":{"color":"#6b7280"}},{"value":1.4,"itemStyle":{"color":"#c48a4e","borderColor":"#c44e4e","borderWidth":2}},{"value":3.5,"itemStyle":{"color":"#c5a44e"}},{"value":4.2,"itemStyle":{"color":"#8b95a1"}},{"value":8,"itemStyle":{"color":"#8b95a1"}},{"value":18,"itemStyle":{"color":"#8b95a1"}},{"value":19,"itemStyle":{"color":"#8b95a1"}},{"value":22,"itemStyle":{"color":"#8b95a1"}}]}]}}'}
### India is the real successor market

India's per-capita consumption is still low enough that growth can be substantial. The open question is whether it follows the older oil-heavy path or reaches scale during an era of cheaper renewables and electric mobility.
:::

::: {.story-step data-step="3" data-update='{"contested-demand-story":{"title":{"subtext":"Southeast Asia and Sub-Saharan Africa are where the leapfrog question becomes decisive."},"series":[{"data":[{"value":0.9,"itemStyle":{"color":"#c48a4e"}},{"value":1.4,"itemStyle":{"color":"#c48a4e"}},{"value":3.5,"itemStyle":{"color":"#c5a44e","borderColor":"#c44e4e","borderWidth":2}},{"value":4.2,"itemStyle":{"color":"#8b95a1"}},{"value":8,"itemStyle":{"color":"#8b95a1"}},{"value":18,"itemStyle":{"color":"#8b95a1"}},{"value":19,"itemStyle":{"color":"#8b95a1"}},{"value":22,"itemStyle":{"color":"#8b95a1"}}]}]}}'}
### The fragmented growth corridor

This is where demand forecasting gets genuinely uncertain. Large populations with low current consumption could add a great deal of oil demand, but they could also leapfrog part of the fossil-heavy development arc.
:::

::: {.story-step data-step="4" data-update='{"contested-demand-story":{"title":{"subtext":"For Alberta, the real market is a mix of plateauing giants, rising India, and uncertain leapfrog regions."},"series":[{"data":[{"value":0.9,"itemStyle":{"color":"#6b7280"}},{"value":1.4,"itemStyle":{"color":"#c48a4e"}},{"value":3.5,"itemStyle":{"color":"#c5a44e"}},{"value":4.2,"itemStyle":{"color":"#4e8ac4"}},{"value":8,"itemStyle":{"color":"#8b95a1"}},{"value":18,"itemStyle":{"color":"#c44e4e"}},{"value":19,"itemStyle":{"color":"#c44e4e"}},{"value":22,"itemStyle":{"color":"#dc2626"}}]}]}}'}
### The Alberta implication

There is still demand ahead. But it is uneven, slower, and more conditional than the old “Asia will absorb it” story suggests. That is why Alberta's advantage increasingly depends on route, reliability, and feedstock relevance rather than simple volume optimism.
:::
:::
:::
...
Follow the Money (FTM). 2025. "Russia's Shadow Fleet Shakes Off Western Sanctions to Keep Oil Revenues Flowing." December 2025. Amsterdam: FTM. <https://www.ftm.eu/russia-shadow-fleet-western-sanctions-oil-revenues>

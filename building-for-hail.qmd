...
<div data-viz="echarts" style="height:380px" data-options='{
  ...
  "series":[{
    "type":"bar",
    "data":[0.49,0.15,0.55,0.08,0.05,0.12,0.22,0.09,0.18,0.08,1.20,0.14,0.08,0.11,2.80],
    "itemStyle":{"color":{"type":"linear","x":0,"y":0,"x2":0,"y2":1,"colorStops":[{"offset":0,"color":"#f59e0b"},{"offset":1,"color":"#92400e"}]}},
    "label":{"show":true,"position":"top","color":"#94a3b8","formatter":"function(v){return v.value>=0.1?\"$\"+v.value.toFixed(2)+\"B\":\"\";}"}
  }]
}'></div>

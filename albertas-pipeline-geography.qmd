...
flowchart TD
    ...
    B -->| Surface — less than 75 m | C["Open-pit mining<br>Shovels · trucks · extraction plant<br>Clark hot water separation"]
    B -->| Deep — greater than 75 m | D["SAGD<br>Steam heats bitumen in situ<br>Drains by gravity to producer well"]
    C --> E["Primary separation<br>Strip residual sand and water<br>Output: raw bitumen"]
    D --> E
    E --> F{Processing route}
    F -->| ~60% of output | G["Diluent blending<br>30% condensate + 70% bitumen<br>Density target: 880 kg per cubic metre<br>Output: dilbit"]
    F -->| ~40% of output | H["Upgrading<br>Coking or hydrocracking<br>Hydrotreating removes sulphur<br>Output: SCO, 32 to 34 degrees API"]
    G --> I["Hardisty Hub<br>Storage · blending · metering<br>Custody transfer point"]
    H --> I
    I --> J["Export pipeline<br>Multiple grades travel in sequence<br>Batch-scheduled transport"]
    J -->| Enbridge — 62% | K["Midwest refineries<br>Sarnia · Superior · Patoka"]
    J -->| Trans Mountain — 19% | L["Pacific terminal<br>Burnaby to tanker to Asia"]
    J -->| Keystone and Express — 19% | M["Gulf Coast<br>Port Arthur · Cushing"]
    K --> N["Crude distillation tower<br>Fractionation by boiling point"]
    L --> N
    M --> N

...
flowchart TD
    ...
    B -->|"Surface &lt; 75 m"| C["Open-pit mining<br>Shovels · trucks · extraction plant<br>Clark hot water separation"]
    B -->|"Deep &gt; 75 m"| D["SAGD<br>Steam heats bitumen in situ<br>Drains by gravity to producer well"]
    C --> E["Primary separation<br>Strip residual sand and water<br>Output: raw bitumen"]
    D --> E
    E --> F{Processing route}
    F -->|"~60 pct of output"| G["Diluent blending<br>30% condensate + 70% bitumen<br>Density target: 880 kg/m3<br>Output: dilbit"]
    F -->|"~40 pct of output"| H["Upgrading<br>Coking or hydrocracking<br>Hydrotreating removes sulphur<br>Output: SCO, 32-34 API"]
    ...
    J -->|"Keystone + Express 19%"| M["Gulf Coast<br>Port Arthur · Cushing"]

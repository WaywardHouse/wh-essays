...
date: 2026-03-07
description: >
  Alberta sits deep within the North American continent, far from
  tidewater yet tightly connected to global markets. This article
  examines how pipelines, railways, and trade corridors overcome the
  constraints of a landlocked geography.
categories:
  - "Economic Geography"
...
<!-- Article figure assets: Leaflet + ECharts loaded once for all figures below -->
...
## Addendum — March 16, 2026: The Fuel Cost Dimension {#addendum-march-2026}

*Added two weeks into the Hormuz crisis. The air connectivity analysis above was written before February 28; the fuel dimension it did not anticipate deserves a direct treatment.*

The article argued that Alberta's air corridor is structurally fragile: dependent on two carriers whose competitive incentives are imperfectly aligned with provincial connectivity interests, operating from a hub that sits at the bottom of both carriers' network hierarchies when capacity is constrained. The Hormuz crisis has added a cost dimension to that structural fragility that was not visible when the original analysis was written.

**The crack spread, and why it matters for aviation specifically.** Global jet fuel prices have not risen in proportion to crude — they have risen faster, and by a different mechanism. The Strait of Hormuz does not merely channel crude oil exports; it also channels a significant fraction of global jet fuel production. Saudi Arabia, the UAE, Kuwait, and Qatar operate some of the world's most modern and export-oriented refinery complexes specifically to produce petroleum products — including jet fuel — for European and Asian aviation markets. When the strait closed, that refinery export capacity went dark simultaneously with the crude. The jet crack spread — the premium above crude at which jet fuel trades — surged from approximately $15/barrel in late February to $85–95/barrel by mid-March: a 20-year high, last approached during the Gulf Coast hurricane season of 2005. IATA's Jet Fuel Price Monitor for the week of March 10 placed the global average at $175/barrel. U.S. retail airport prices reached $3.99/gallon by approximately March 14, up from $2.50 on February 27 — a 60% increase in a fortnight.

**The Alberta production proximity argument — and why it does not fully hold.** There is a reasonable structural case that YYC and YEG should be partially insulated from this disruption. The Strathcona Refinery (Imperial Oil, Edmonton) processes approximately 187,000 barrels per day of Alberta crude — production that is entirely disconnected from Hormuz supply chains — and supplies approximately 30% of all petroleum products sold in western Canada, including aviation fuel into the Edmonton and Calgary airport systems. The physical supply chain from oil sands wellhead to aircraft wing at YEG is the shortest such chain for any major North American hub airport: no marine freight, no port exposure, no Hormuz-dependent refinery. In theory, this is a meaningful structural advantage.

In practice, jet fuel pricing at Canadian airports benchmarks against North American and global spot markets rather than local production cost. The crack spread widening that is driving prices at Heathrow and Narita is also driving prices at YYC, because the pricing formula flows from published benchmarks regardless of where the physical molecules were refined. Alberta's refinery proximity does not translate into a YYC price discount relative to global peers — it translates into supply security, which is a different (and quieter) form of resilience.

**The specific connectivity exposure.** The fuel cost problem is not symmetric across the YYC route network. Domestic flights — Calgary to Vancouver, to Toronto, to Edmonton — are fueled predominantly within the Canadian refinery system at both ends, and the fare increases on these routes, while real, reflect broadly North American conditions. The structural exposure is concentrated in the routes that matter most for Alberta's international connectivity: the transborder services to Chicago, Denver, and Houston that carry energy sector and business travel; and the long-haul international services — WestJet's YYC–London Heathrow, Air Canada's onward connections through YYZ and YVR to Tokyo, London, and Frankfurt — where fuel is purchased at both origin and destination airports, and where the destination fuel cost is priced against European or Asian spot markets that are fully exposed to the crack spread dislocation.

Air Canada has already applied surcharges of $25–$50 per passenger on long-haul routes to Australia, Japan, and Thailand. WestJet has signalled fare adjustments of up to 20% on select routes. Neither carrier has specifically disclosed the YYC pricing impact, but the fare increases that have been reported as applying to WestJet's transatlantic service and Air Canada's Pacific connections would apply directly to the Calgary-origin passengers using those routes. For a hub that was already seeing route rationalization before February 28, surcharges of this magnitude represent a further demand suppression on exactly the international routes the province most needs to maintain.

The tankering question has a different valence in this context than it would under normal conditions. With crack spreads at historic highs at European and Asian airports while North American airports — including YYC, supplied by crisis-insulated Alberta refineries — face lower crack spread exposure, airlines operating transoceanic services through YYC have a meaningful incentive to load additional fuel at Calgary before departing for expensive destinations. Whether they can act on that incentive is constrained by aircraft range envelopes and maximum payload weights, but the directional pressure exists: YYC's refinery proximity, which does not produce a price discount in normal conditions, may produce one now.

The compounding logic of this article's central argument is at this point operating without restraint. Alberta's air connectivity is simultaneously facing reduced route frequencies from pre-crisis rationalization, fare increases driven by fuel cost shocks from a crisis occurring 10,000 kilometres away, and a structural question about whether the two carriers on whose competitive behaviour all of this depends have the financial capacity — post-pandemic, post-PE restructuring, mid-fuel-shock — to maintain the long-haul international services that transform YYC from a regional node into a genuine international gateway. The province produces more oil and gas than almost any jurisdiction on the continent. The aircraft that fly its residents to markets, clients, and family are repriced by events at a narrow strait in the Persian Gulf, routed through a carrier whose owners sit in Toronto, and increasingly concentrated on routes its competitors have decided not to contest.
...
AerCap Holdings. 2025. "Q1 2025 Earnings Call Transcript." April 29, 2025. Remarks by CEO Aengus Kelly on tariff cost impacts per widebody aircraft.

Airbus SE. 2025. "Airbus Statement on US Tariff Impacts on Aerospace Supply Chains." Press release, April 2025.

Boeing Company. 2025. "Q1 2025 Earnings Call." April 23, 2025. Remarks by CFO Brian West on first-quarter tariff impact.

Canada Competition Bureau. 2023. *Air Passenger Services: Market Study.* Gatineau: Competition Bureau Canada.

Canada West Foundation. 2025. *By Rail, Road and Sea: Western Export Infrastructure Needs a Refresh.* Calgary: Canada West Foundation.

Combes, Pierre-Philippe, and Miren Lafourcade. 2005. "Transport Costs: Measures, Determinants, and Regional Policy Implications for France." *Journal of Economic Geography* 5 (3): 319–349. <https://doi.org/10.1093/jnlecg/lbh064>

Government of Alberta, Government of Saskatchewan, and Government of Manitoba. 2023. *Prairie Provinces Memorandum of Understanding on Economic Cooperation.* Signed April 2023.

IATA (International Air Transport Association). 2025. *Jet Fuel Price Monitor.* Montreal: IATA. <https://www.iata.org/en/publications/economics/fuel-monitor/>

Limão, Nuno, and Anthony J. Venables. 2001. "Infrastructure, Geographical Disadvantage, Transport Costs, and Trade." *World Bank Economic Review* 15 (3): 451–479. <https://doi.org/10.1093/wber/15.3.451>

OAG Aviation Worldwide. 2025. *Canada–US Route Booking Analytics, Q1 2025.* London: OAG.

Statistics Canada. 2025. *International Travel Survey: Characteristics of Canadian Travellers.* Ottawa: Statistics Canada. Catalogue no. 66-001-X. <https://www150.statcan.gc.ca/n1/pub/66-001-x/66-001-x2025001-eng.htm>

Transport Canada. 2024. *Transportation in Canada: Annual Report.* Ottawa: Minister of Transport. <https://tc.canada.ca/en/corporate-services/transparency/corporate-management-reporting/transportation-canada-annual-reports>

Transport Canada. 2025. *National Trade Corridors Fund: Funded Projects.* Ottawa: Transport Canada. <https://tc.canada.ca/en/rail-transportation/national-trade-corridors-fund/funded-projects>

---

*This article is part of the **Alberta in Context** series, which examines Alberta's economic geography through quantitative and spatial analytical lenses. The series does not advocate for particular policy positions but aims to document the structural conditions that shape the province's economic geography with analytical rigor and impartiality.*

...
<p class="viz-caption">Source: Author scenarios based on Goldman Sachs energy research note, March 9, 2026 (no public URL available); JPMorgan Commodities research (no public URL available); IEA energy security analysis (<https://www.iea.org/frequently-asked-questions-on-energy-security>). The rapid resolution scenario implies a return to pre-crisis $87/bbl levels over 4–6 weeks. Extended closure would push prices well above the Sunday peak.</p>
